...
Battleship.prototype.drawBoard = function(){
	...
	document.getElementById("map").innerHTML = '<table><tr><th class="margin">'+margin+"</th></tr>"+bstring+"</table>";
}
...
Battleship.prototype.drawStats = function(){
	...
	document.getElementById("stats").innerHTML = "Out of "+b.amountOfGames+" games, the average amount of shots fired to complete a game was "+b.overallStats.average;
}

/*Will return back the cells state Unknown/Missed/Hit */
Battleship.prototype.getCellState = function(coord){

	if(this.board[coord[0]][coord[1]] == "2")
		return "Hit";
	else if(this.board[coord[0]][coord[1]] == "1")
		return "Miss";
	else if(this.board[coord[0]][coord[1]] == "0")
		return "Unknown";
}
...
Battleship.prototype.randomCoordinate = function(){
	do{
		var coord = [Math.floor((Math.random() * this.boardSize) + 0), Math.floor((Math.random() * this.boardSize) + 0)];
